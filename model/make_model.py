...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory):
        ...
        self.base.cls_token_dis_rgb.data = self.base.cls_token.data
        self.base.cls_token_dis_ir.data = self.base.cls_token.data
        self.base.pos_embed_f.data = torch.cat((self.base.pos_embed.data[:,0,:].unsqueeze(dim=1), self.base.pos_embed.data),dim=1)
    ...
    def forward(self, x, label=None, cam_label= None, view_label=None, mode=0):
        global_feat, specific_feat = self.base(x, cam_label=cam_label, view_label=view_label, mode=mode)
        if self.reduce_feat_dim:
            global_feat = self.fcneck(global_feat)
        feat = self.bottleneck(global_feat)
